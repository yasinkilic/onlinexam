...
<div class="card">
    ...
    <div class="card-body">
<form action="{{route('Admin.posts.store')}}" class="contact_form_box" method="post" enctype="multipart/form-data" novalidate="novalidate">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group text_box">
                ...
                <hr>
                <textarea class="form-control summernote" name="body" placeholder="İçerik Alanı.."></textarea>
            </div>
        </div>
